...
setup(
    ...
    description='A 2D jumping monopod',  # Optional
    ...
    # project.
    #author='Roy Xing',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    #author_email='roy@massrobotics.org',  # Optional
